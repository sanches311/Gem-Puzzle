...
function getFrameSizeHtml() {
  ...
  return "\n<span class='frame-current-size'> Frame size: ".concat(size, "\u0445").concat(size, "</span>");
}
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".wrapper {\n  display: flex;\n  position: fixed;\n  width: 100%;\n  height: 100%;\n  left: 0;\n  top: 0;\n  justify-content: center;\n  align-items: center;\n  overflow: auto;\n  background-size: cover; }\n\n.wrapper-frame {\n  display: flex;\n  justify-content: center;\n  align-items: center; }\n\n.frame {\n  width: 500px;\n  height: 500px;\n  border: 10px solid greenyellow;\n  border-radius: 5px;\n  box-sizing: border-box;\n  margin-top: 10px;\n  margin-bottom: 10px; }\n  @media screen and (max-width: 1280px) {\n    .frame {\n      width: 400px;\n      height: 400px; } }\n  @media screen and (max-width: 768px) {\n    .frame {\n      width: 300px;\n      height: 300px; } }\n\n.frame-row {\n  position: relative;\n  display: flex;\n  flex-direction: row;\n  height: 25%; }\n\n.frame-item {\n  position: relative;\n  display: flex;\n  z-index: 99;\n  align-items: center;\n  justify-content: center;\n  font-size: 1.5rem;\n  width: 25%;\n  margin: 1px;\n  border: 2px solid greenyellow;\n  border-radius: 10px;\n  background-color: goldenrod;\n  box-sizing: border-box; }\n  .frame-item:hover {\n    cursor: pointer;\n    background-color: aquamarine;\n    transform: scale(1.01); }\n\n.frame-size:hover {\n  cursor: pointer; }\n\n.active-size-frame {\n  color: green; }\n\n.frame-all {\n  display: flex;\n  justify-content: center; }\n\n.empty-item {\n  background-color: white;\n  opacity: .001;\n  border: 0; }\n\n.active-dropzone {\n  background-color: orange;\n  opacity: 1; }\n\n.move-down {\n  animation: to-down .2s; }\n\n.move-up {\n  animation: to-up .2s; }\n\n.move-left {\n  animation: to-left .2s; }\n\n.move-right {\n  animation: to-right .2s; }\n\n@keyframes to-down {\n  from {\n    top: -100%; }\n  to {\n    top: 0; } }\n\n@keyframes to-up {\n  from {\n    bottom: -100%; }\n  to {\n    bottom: 0; } }\n\n@keyframes to-left {\n  from {\n    right: -50px; }\n  to {\n    right: 0px; } }\n\n@keyframes to-right {\n  from {\n    left: -50px; }\n  to {\n    left: 0px; } }\n\n.modal-wrapper {\n  display: none;\n  position: fixed;\n  align-items: center;\n  justify-content: center;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  background-color: azure; }\n\nbody {\n  background-color: gray; }\n\n.countMove {\n  width: 50px; }\n\n.winnner {\n  display: none;\n  justify-content: center;\n  align-items: center;\n  flex-direction: column; }\n\ntable {\n  width: 80%;\n  border-collapse: collapse; }\n\ntd, tr, caption {\n  padding: 3px;\n  border: 1px solid green;\n  text-align: center; }\n\n.menu-btn {\n  background-color: aquamarine;\n  border: 0;\n  border-radius: 5px;\n  font-size: 1rem;\n  padding: 5px;\n  margin-right: 10px; }\n  .menu-btn:hover {\n    cursor: pointer;\n    background-color: aqua; }\n\n.frame-size {\n  background-color: aquamarine;\n  border: 0;\n  border-radius: 5px;\n  font-size: 1rem;\n  padding: 5px;\n  margin-right: 10px; }\n  .frame-size:hover {\n    cursor: pointer;\n    background-color: aqua; }\n\n.menu {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  margin-bottom: 10px; }\n\n.info {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between; }\n\n.count-move {\n  font-size: 1rem; }\n\n.count-time {\n  font-size: 1rem; }\n\n.frame-all {\n  margin-top: 10px; }\n", "",{"version":3,"sources":["webpack://./src/style/layout/_wrapper.scss","webpack://./src/style/base/_frame.scss","webpack://./src/style/base/_modal.scss","webpack://./src/style/base/_input.scss","webpack://./src/style/base/_winners.scss","webpack://./src/style/base/_button.scss","webpack://./src/style/base/_menu.scss","webpack://./src/style/base/_info.scss"],"names":[],"mappings":"AAAA;EACG,aAAa;EACb,eAAe;EACf,WAAW;EACX,YAAY;EACZ,OAAM;EACN,MAAK;EACL,uBAAuB;EACvB,mBAAmB;EACnB,cAAc;EACd,sBAAsB,EAAA;;ACVzB;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB,EAAA;;AAErB;EACI,YAAW;EACX,aAAY;EACZ,8BAA8B;EAC9B,kBAAkB;EAClB,sBAAsB;EACtB,gBAAgB;EAChB,mBAAmB,EAAA;EACnB;IARJ;MASM,YAAW;MACX,aAAY,EAAA,EAOjB;EALG;IAZJ;MAaQ,YAAW;MACX,aAAY,EAAA,EAGnB;;AACD;EACI,kBAAkB;EAClB,aAAa;EACb,mBAAmB;EACnB,WAAW,EAAA;;AAEf;EACI,kBAAkB;EAClB,aAAa;EACb,WAAW;EACX,mBAAmB;EACnB,uBAAuB;EACvB,iBAAiB;EACjB,UAAU;EACV,WAAW;EACX,6BAA6B;EAC7B,mBAAmB;EACnB,2BAA0B;EAC1B,sBAAsB,EAAA;EAZ1B;IAcQ,eAAe;IACf,4BAA4B;IAC5B,sBAAsB,EAAA;;AAG9B;EAEQ,eAAe,EAAA;;AAGvB;EACI,YAAY,EAAA;;AAEhB;EACE,aAAa;EACb,uBAAuB,EAAA;;AAGzB;EACI,uBAAuB;EACvB,aAAa;EACb,SAAS,EAAA;;AAEb;EACI,wBAAwB;EACxB,UAAU,EAAA;;AAEd;EACI,sBAAsB,EAAA;;AAE1B;EACI,oBAAoB,EAAA;;AAExB;EACI,sBAAsB,EAAA;;AAE1B;EACI,uBAAuB,EAAA;;AAG3B;EACI;IACI,UAAW,EAAA;EAEb;IACE,MAAM,EAAA,EAAA;;AAGd;EACI;IACI,aAAY,EAAA;EAEZ;IACA,SAAS,EAAA,EAAA;;AAGjB;EACI;IACI,YAAW,EAAA;EAEX;IACA,UAAU,EAAA,EAAA;;AAGlB;EACI;IACI,WAAW,EAAA;EAEX;IACA,SAAS,EAAA,EAAA;;AChHjB;EACI,aAAa;EACb,eAAe;EACf,mBAAmB;EACnB,uBAAuB;EACvB,OAAO;EACP,MAAK;EACL,WAAW;EACX,YAAY;EACZ,uBAAuB,EAAA;;AAG3B;EACE,sBAAsB,EAAA;;ACbxB;EACI,WAAW,EAAA;;ACDf;EACI,aAAa;EACb,uBAAuB;EACvB,mBAAmB;EACnB,sBAAsB,EAAA;;AAE1B;EACE,UAAU;EACV,yBAAyB,EAAA;;AAE3B;EACE,YAAY;EACZ,uBAAuB;EACvB,kBAAkB,EAAA;;ACbpB;EACI,4BAA4B;EAC5B,SAAS;EACT,kBAAkB;EAClB,eAAe;EACf,YAAY;EACZ,kBAAkB,EAAA;EANtB;IASQ,eAAe;IACf,sBAAsB,EAAA;;AAI9B;EACE,4BAA4B;EAC5B,SAAS;EACT,kBAAkB;EAClB,eAAe;EACf,YAAY;EACZ,kBAAkB,EAAA;EANpB;IASM,eAAe;IACf,sBAAsB,EAAA;;ACxB5B;EACI,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,mBAAmB,EAAA;;ACJvB;EACI,aAAa;EACb,mBAAmB;EACnB,8BAA8B,EAAA;;AAElC;EACI,eAAe,EAAA;;AAEnB;EACI,eAAe,EAAA;;AAGnB;EACE,gBAAgB,EAAA","sourcesContent":[".wrapper {\n   display: flex;\n   position: fixed;\n   width: 100%;\n   height: 100%;\n   left:0;\n   top:0;\n   justify-content: center;\n   align-items: center;\n   overflow: auto;\n   background-size: cover;\n}\n\n",".wrapper-frame {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.frame {\n    width:500px;\n    height:500px;\n    border: 10px solid greenyellow;\n    border-radius: 5px;\n    box-sizing: border-box;\n    margin-top: 10px;\n    margin-bottom: 10px;\n    @media screen and (max-width: 1280px) {\n      width:400px;\n      height:400px;\n    }\n    @media screen and (max-width: 768px) {\n        width:300px;\n        height:300px;\n      }\n\n}\n.frame-row {\n    position: relative;\n    display: flex;\n    flex-direction: row;\n    height: 25%;\n}\n.frame-item {\n    position: relative;\n    display: flex;\n    z-index: 99;\n    align-items: center;\n    justify-content: center;\n    font-size: 1.5rem;\n    width: 25%;\n    margin: 1px;\n    border: 2px solid greenyellow;\n    border-radius: 10px;\n    background-color:goldenrod;\n    box-sizing: border-box;\n    &:hover {\n        cursor: pointer;\n        background-color: aquamarine;\n        transform: scale(1.01);\n    }\n}\n.frame-size {\n        &:hover {\n        cursor: pointer;\n    }\n}\n.active-size-frame {\n    color: green;\n}\n.frame-all {\n  display: flex;\n  justify-content: center;\n}\n\n.empty-item {\n    background-color: white;\n    opacity: .001;\n    border: 0;\n}\n.active-dropzone {\n    background-color: orange;\n    opacity: 1;\n}\n.move-down {\n    animation: to-down .2s;\n}\n.move-up {\n    animation: to-up .2s;\n}\n.move-left {\n    animation: to-left .2s;\n}\n.move-right {\n    animation: to-right .2s;\n}\n\n@keyframes to-down{\n    from {\n        top : -100%;\n      }\n      to {\n        top: 0;\n      }\n    }\n@keyframes to-up{\n    from {\n        bottom:-100%;\n        }\n        to {\n        bottom: 0;\n        }\n    }\n@keyframes to-left{\n    from {\n        right:-50px;\n        }\n        to {\n        right: 0px;\n        }\n    }\n@keyframes to-right{\n    from {\n        left :-50px;\n        }\n        to {\n        left: 0px;\n        }\n    }\n",".modal-wrapper {\n    display: none;\n    position: fixed;\n    align-items: center;\n    justify-content: center;\n    left: 0;\n    top:0;\n    width: 100%;\n    height: 100%;\n    background-color: azure;\n\n}\nbody {\n  background-color: gray;\n}\n",".countMove {\n    width: 50px;\n}",".winnner {\n    display: none;\n    justify-content: center;\n    align-items: center;\n    flex-direction: column;\n}\ntable {\n  width: 80%;\n  border-collapse: collapse;\n}\ntd, tr, caption {\n  padding: 3px;\n  border: 1px solid green;\n  text-align: center;\n}\n",".menu-btn{\n    background-color: aquamarine;\n    border: 0;\n    border-radius: 5px;\n    font-size: 1rem;\n    padding: 5px;\n    margin-right: 10px;\n\n    &:hover {\n        cursor: pointer;\n        background-color: aqua;\n    }\n\n}\n.frame-size {\n  background-color: aquamarine;\n  border: 0;\n  border-radius: 5px;\n  font-size: 1rem;\n  padding: 5px;\n  margin-right: 10px;\n\n  &:hover {\n      cursor: pointer;\n      background-color: aqua;\n  }\n\n}\n",".menu {\n    display: flex;\n    flex-direction: row;\n    justify-content: center;\n    margin-bottom: 10px;\n}\n",".info {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-between;\n}\n.count-move {\n    font-size: 1rem;\n}\n.count-time {\n    font-size: 1rem;\n}\n\n.frame-all {\n  margin-top: 10px;\n}\n"],"sourceRoot":""}]);
// Exports
